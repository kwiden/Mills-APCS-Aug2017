...
public class DoMath {
	...
	public static void main(String[] args) {
		...
		testDoMath("testing average 3 numbers with -5.0, 2.0, 15", 4.0, Calculate.average(-5.0, 2, 15));
		...
		testDoMath("testing toMixedNum with -9/3 (warning if wrong)", "-3", Calculate.toMixedNum(-9, 3));
		...
		testDoMath("testing absValue with -2.1", 2.1, Calculate.absValue(-2.1));
		...
		testDoMath("testing quadForm with two real roots (smaller root should come first) \n\t\t", "-2.00 and 5.00",
				Calculate.quadForm(1, -3, -10));
